    ...
    DOM.pageContent.innerHTML = `
        ...
        <div class="toolbar">
            ...
            <div>
                ...
                <div class="panel-subtitle">
                    QUALITY — Quality Events, Complaints and CAPA.
                </div>
            </div>
        ...
        <div class="panel report-filter-panel">
            ...
            <div class="panel-header">
                ...
                <div>
                    ...
                    <div class="panel-subtitle">
                        Filters apply to the selected report.
                    </div>
                </div>
        ...
        <div class="report-card-grid">
            ...
            ${qualityReportCard(
                "QRT-001",
                "Quality Events Report",
                "Quality events, severity, risk, ownership, overdue position and closure.",
            )}

            ${qualityReportCard(
                "QRT-002",
                "Complaints Report",
                "Customer complaints, severity, investigation, CAPA linkage and closure.",
            )}

            ${qualityReportCard(
                "QRT-003",
                "CAPA Management Report",
                "CAPA status, priority, risk, overdue actions and effectiveness.",
            )}

        </div>

        <div class="panel" id="qmsReportResult" style="display:none;">

            <div class="panel-header">

                <div>
                    <div class="panel-title" id="qmsReportTitle">
                        Report
                    </div>

                    <div class="panel-subtitle" id="qmsReportMeta">
                    </div>
                </div>
            ...
            <div class="panel-body">
                ...
                <div id="qmsReportSummary"></div>

                <div id="qmsReportDownloads"
                     style="margin-top:16px;">
                </div>

                <div id="qmsReportPreview"
...
function qualityReportCard(
    ...
    return `
        ...
        <div class="panel report-card">
            ...
            <div class="panel-subtitle report-card-description">
            ...
            <button
                type="button"
                class="btn btn-primary"
                onclick="generateQMSReport('${escapeJs(reportId)}', this)"
            >
                Generate Report
            </button>
...
async function generateQMSReport(
    reportId,
    button
) {
...
function renderQMSReportResult(
    result
) {
    ...
    if (summary) {
        ...
        summary.innerHTML = `
            ...
            <div class="stat-grid">
                ...
                <div class="stat-card">
                    <span>High Risk</span>
                    <strong>${s.highRisk || 0}</strong>
                </div>

                <div class="stat-card">
                    <span>Critical Risk</span>
                    <strong>${s.criticalRisk || 0}</strong>
                </div>

                <div class="stat-card">
                    <span>CAPA Required</span>
                    <strong>${s.capaRequired || 0}</strong>
                </div>

                <div class="stat-card">
                    <span>Pending Effectiveness</span>
                    <strong>${s.pendingEffectiveness || 0}</strong>
                </div>
        ...
        if (!rows.length) {
            ...
            preview.innerHTML = `
                <div class="panel-subtitle">
                    ...
                    The report files have still been generated.
                </div>
            `;
                ...
                (result.rows || []).length > 50
                    ? `
                        <div class="panel-subtitle"
                            ...
                            Full data is available in Excel/CSV.
                        </div>
                      `
                    : ""
            }
...
window.generateQMSReport = generateQMSReport;
